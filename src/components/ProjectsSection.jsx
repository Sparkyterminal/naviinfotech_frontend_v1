...
const projectsData = [
  {
    ...
    description: "talkitoutwithyl is a safe space to share your thoughts, feelings, and challenges. We connect you with professional guidance through one-on-one sessions designed to help you heal, grow, and find clarity.",
  ...
  },
  {
    ...
    description: "Nuvo Hosting Agency specializes in providing professional hostesses and event management solutions, ensuring every event runs seamlessly and leaves a lasting impression.",
  ...
  },
  {
    id: 3,
    title: "KitchenViz",
    description: "KitchenViz is your one-stop e-commerce destination for premium kitchen appliances. From smart solutions to everyday essentials, we bring quality products that make cooking easier and more enjoyable.",
  ...
  },
  {
    ...
    description: "Madara Mahasabha is a community website built to unite, empower, and support members of the Madara community. It serves as a platform for connection, collaboration, and cultural growth.",
  ...
  },
  {
    ...
    description: "BGS School Management is a smart attendance and dashboard system designed to simplify school administration. It helps track student attendance, monitor performance, and streamline daily operations.",
    ...
    <div className="w-full relative rounded-3xl overflow-hidden bg-gradient-to-r from-[#1D2235] to-[#121318] p-4 md:p-6 lg:p-8">
      ...
      <div className="relative z-10">
        <Lens hovering={hovering} setHovering={setHovering}>
          <div className={`w-full h-48 md:h-56 lg:h-64 rounded-2xl bg-gradient-to-br ${project.gradient} flex items-center justify-center overflow-hidden`}>
            <img
              src={project.image}
              alt={project.title}
  ...
  return (
    <section className="min-h-screen px-4 py-16 bg-black">
      ...
      <div className="max-w-7xl mx-auto text-center mb-16">
        ...
        <p className="text-lg md:text-xl text-zinc-400 font-[neu] mt-4 max-w-2xl mx-auto">
          Discover our innovative solutions and creative projects that drive digital transformation
        </p>
      </div>
...
const Rays = ({ className }) => {
  return (
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className={cn("absolute left-0 top-0 pointer-events-none z-[1] scale-75 md:scale-90 lg:scale-100", className)}>
